...
<!---Documatic-section-axi.drawing.Drawing-start--->
## [axi.drawing.Drawing](7-axi_drawing.md#axi.drawing.Drawing)

<!---Documatic-section-Drawing-start--->
<!---Documatic-block-axi.drawing.Drawing-start--->
<details>
	<summary><code>axi.drawing.Drawing</code> code snippet</summary>
...
class Drawing(object):
    ...
    def scale_to_fit_height(self, height, padding=0):
        return self.scale_to_fit(1000000000.0, height, padding)

    def scale_to_fit_width(self, width, padding=0):
        return self.scale_to_fit(width, 1000000000.0, padding)
    ...
    def render(self, scale=109, margin=1, line_width=0.35 / 25.4, bounds=None, show_bounds=True):
        if cairo is None:
...
<!---Documatic-block-axi.drawing.Drawing-end--->
<!---Documatic-section-Drawing-end--->

# #
<!---Documatic-section-axi.drawing.Drawing-end--->
